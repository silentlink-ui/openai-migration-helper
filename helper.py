...
MODEL_MAP = {
    "gpt-4o": {"model": "deepseek-ai/DeepSeek-V4-Flash", "savings": "40x", "note": "Best overall value"},
    ...
    "gpt-4": {"model": "deepseek-ai/DeepSeek-V4-Flash", "savings": "40x", "note": "Comparable quality"},
...
def suggest(model_name):
    ...
    if mapped:
        ...
        print(f"No exact mapping for {model_name}. Try deepseek-ai/DeepSeek-V4-Flash (best value).")
